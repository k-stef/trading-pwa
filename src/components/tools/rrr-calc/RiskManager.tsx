...
const RiskManager: React.FC = () => {
    ...
    return (
        <Grid container spacing={3} direction="column">
            ...
            {/* Position Size Display mit allen Risk/Reward Informationen */}
            {calculationResult && validationErrors.length === 0 && (
                <Grid>
                    <PositionSizeDisplay
                        ...
                        riskRatio={riskRatio}
                        rewardRatioBeforeTaxes={rewardRatioBeforeTaxes}
                        rewardRatioAfterTaxes={rewardRatioAfterTaxes}
                    />
                </Grid>
            )}

            {/* Risk/Reward Ratio Output (nur für Fehler wenn keine Berechnung) */}
            {validationErrors.length === 0 && !calculationResult && (
                <Grid>
                    <RatioOutput
